...
; .FSTART _timer0_ovf_isr
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 001F     TCNT0=0x0C;
	LDI  R30,LOW(12)
	OUT  0x32,R30
; 0000 0020 
; 0000 0021     if (current == 0) {
	MOV  R0,R6
	OR   R0,R7
	BRNE _0x3
; 0000 0022         PORTB.0 = 1;
...
; 0000 004E     PORTB = 0x00;
	...
	OUT  0x18,R30
; 0000 004F 
; 0000 0050     TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (0<<WGM01) | (1<<CS02) | (0<<CS01) | (0<<CS00);
	LDI  R30,LOW(4)
	OUT  0x33,R30
; 0000 0051     TCNT0=0x0C;
	LDI  R30,LOW(12)
	OUT  0x32,R30
; 0000 0052     OCR0=0x00;
	LDI  R30,LOW(0)
...
; 0000 0061     TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (1<<TOIE0);
	LDI  R30,LOW(1)
	OUT  0x39,R30
; 0000 0062     MCUCR=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	LDI  R30,LOW(0)
	OUT  0x35,R30
...
; 0000 0067     ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 0068     SPCR=(0<<SPIE) | (0<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (0<<SPR0);
	OUT  0xD,R30
...
; 0000 006D     while (1) {
_0x30:
; 0000 006E         if(PINC.1==0) {
	SBIC 0x13,1
	RJMP _0x33
; 0000 006F             if(direction<=0){
	CLR  R0
	CP   R0,R4
	CPC  R0,R5
	BRLT _0x34
; 0000 0070                 direction = 1;
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	MOVW R4,R30
; 0000 0071                 if(current<3) {
	LDI  R30,LOW(3)
	LDI  R31,HIGH(3)
	CP   R6,R30
	CPC  R7,R31
...
; 0000 0076             }else {
	RJMP _0x37
_0x34:
; 0000 0077                direction = -1;
	LDI  R30,LOW(65535)
	LDI  R31,HIGH(65535)
	MOVW R4,R30
; 0000 0078                if(current>0){
	CLR  R0
	CP   R0,R6
	CPC  R0,R7
	BRGE _0x38
